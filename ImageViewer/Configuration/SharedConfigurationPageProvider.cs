...
namespace Macro.ImageViewer.Configuration
{
	...
	{
        public const string LocalConfigurationPath = "DicomServer";
        public const string ServerConfigurationPath = LocalConfigurationPath + @"/" + "Server";
        public const string DicomSendConfigurationPath = LocalConfigurationPath + @"/" + "DicomSend";
        public const string StorageConfigurationPath = LocalConfigurationPath + @"/" + "Storage";
        public const string PriorsServerConfigurationPath = LocalConfigurationPath + @"/" + "PriorsServers";
        public const string PublishingConfigurationPath = "Publishing";

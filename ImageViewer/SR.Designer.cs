...
namespace Macro.ImageViewer {
    ...
    public class SR {
        ...
        public static string FormatRatio {
            get {
                return ResourceManager.GetString("FormatRatio", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 共{0}序列，{1}幅图像 的本地化字符串。
        /// </summary>
        public static string FormatSeriesAndSopCountString {
            get {
                return ResourceManager.GetString("FormatSeriesAndSopCountString", resourceCulture);
            }
        }

...
namespace Macro.ImageViewer.StudyManagement
{
	/// <summary>
	/// </summary>
    [MenuAction("show", "global-toolbars/MenuTools/MenuActivityMonitor", "Show")]
	[Tooltip("show", "TooltipActivityMonitor")]
    [IconSet("show", "Icons.ActivityMonitorSmall.png", "Icons.ActivityMonitorMedium.png", "Icons.ActivityMonitorLarge.png")]

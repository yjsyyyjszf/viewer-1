...
namespace Macro.ImageViewer
{
    ...
    public class ImageSetTreeGroupItem : IImageSetTreeItem, IDisposable
    {
        ...
        public ImageSetTreeGroupItem(FilteredGroup<IImageSet> group, ImageSetTreeGroupItem parent, ITreeItemBinding binding)
            : this(group, parent._imageSetComparer, binding)
        {
            _parent = parent;
        }

        public ImageSetTreeGroupItem(FilteredGroup<IImageSet> group, IComparer<IImageSet> imageSetComparer, ITreeItemBinding binding)
        {
            _group = group;

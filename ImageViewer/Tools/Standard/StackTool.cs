...
namespace Macro.ImageViewer.Tools.Standard
{
    ...
    {
        protected MemorableUndoableCommand _memorableCommand;
        protected int _initialPresentationImageIndex;
        protected IImageBox _currentImageBox;
        ...
        protected static string GetActionKey(ImageComparerList.Item item)
        {
        ...
        protected void CaptureBeginState(IImageBox imageBox)
        {
        ...
        protected bool CaptureEndState()
        {
        ...
        protected static void AdvanceImage(int increment, IImageBox selectedImageBox)
        {

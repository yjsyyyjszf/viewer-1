...
namespace Macro.ImageViewer.Tools.Standard
{
    ...
    [ActionPlaceholder("auto", "Printimageviewer-contextmenu/MenuWindowLevelPresets/MenuWindowLevelPresetList", "Tools.Image.Manipulation.Lut.Presets")]
	...
	public partial class WindowLevelTool
	{
        ...
        {
            if (this.Context.Viewer is PrintImageViewerComponent)
            {
                return CreateActions("Printimageviewer-contextmenu");
            }

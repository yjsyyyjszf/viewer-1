...
namespace Macro.ImageViewer.Tools.Standard
{
    ...
    #region ��ӡ
    [MenuAction("activate", "Printimageviewer-contextmenu/MenuZoom", "Select", Flags = ClickActionFlags.CheckAction)]
    [KeyboardAction("zoomin", "Printimageviewer-keyboard/ToolsStandardZoom/ZoomIn", "ZoomIn", KeyStroke = XKeys.OemPeriod)]
    [KeyboardAction("zoomout", "Printimageviewer-keyboard/ToolsStandardZoom/ZoomOut", "ZoomOut", KeyStroke = XKeys.OemComma)]
    #endregion

...
{
    [MenuAction("undo", "Printimageviewer-contextmenu/MenuUndo", "Undo", KeyStroke = XKeys.Control | XKeys.Z, InitiallyAvailable = false)]
    ...
    [MenuAction("redo", "Printimageviewer-contextmenu/MenuRedo", "Redo", KeyStroke = XKeys.Control | XKeys.Y, InitiallyAvailable = false)]

...
namespace Macro.ImageViewer.Tools.Standard
{
    ...
    [EnabledStateObserver("activateTextCallout", "Enabled", "EnabledChanged")]
    ...
    [EnabledStateObserver("selectTextCallout", "Enabled", "EnabledChanged")]
    ...
    [EnabledStateObserver("selectTextArea", "Enabled", "EnabledChanged")]

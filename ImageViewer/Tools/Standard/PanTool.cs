...
{
    //[MenuAction("activate", "Printimageviewer-contextmenu/MenuPan", "Select", Flags = ClickActionFlags.CheckAction)]
    ...
    [KeyboardAction("panleft", "Printimageviewer-keyboard/ToolsStandardPan/PanLeft", "PanLeft", KeyStroke = XKeys.Control | XKeys.Left)]
    [KeyboardAction("panright", "Printimageviewer-keyboard/ToolsStandardPan/PanRight", "PanRight", KeyStroke = XKeys.Control | XKeys.Right)]
    [KeyboardAction("panup", "Printimageviewer-keyboard/ToolsStandardPan/PanUp", "PanUp", KeyStroke = XKeys.Control | XKeys.Up)]
    [KeyboardAction("pandown", "Printimageviewer-keyboard/ToolsStandardPan/PanDown", "PanDown", KeyStroke = XKeys.Control | XKeys.Down)]

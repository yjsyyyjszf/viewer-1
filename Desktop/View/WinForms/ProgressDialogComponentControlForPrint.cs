...
namespace Macro.Desktop.View.WinForms
{
    ...
    /// </summary>
    public partial class ProgressDialogComponentControlForPrint : ApplicationComponentUserControl
    {
        ...
        /// Constructor
        /// </summary>
        public ProgressDialogComponentControlForPrint(ProgressDialogComponentForPrint component)
            : base(component)
        {
            InitializeComponent();
        ...
        ~ProgressDialogComponentControlForPrint()
        {
            _component.ProgressUpdateEvent -= OnProgressUpdate;
            _component.ProgressTerminateEvent -= OnProgressTerminate;
        }

...
namespace Macro.Desktop
{
    ...
    /// </summary>
    [ExtensionPoint]
	public sealed class ProgressDialogComponentForPrintViewExtensionPoint : ExtensionPoint<IApplicationComponentView>
    {
    }
	...
	/// </remarks>
    [AssociateView(typeof(ProgressDialogComponentForPrintViewExtensionPoint))]
    public class ProgressDialogComponentForPrint : ApplicationComponent
    {
        ...
        public ProgressDialogComponentForPrint(BackgroundTask task, bool autoClose, ProgressBarStyle progressBarStyle, string startProgressMessage = null)
        {
            _task = task;
